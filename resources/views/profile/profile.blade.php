                ...
                <form action="/profile/update-password" method="POST">
                    ...
                    <div class="space-y-3">
                        ...
                        <form method="POST" action="{{ route('profile.password.update') }}">
                            ...
                            <button type="submit" formaction="{{ route('profile.password.update') }}" class="w-full bg-custom-orange text-white font-bold py-2 px-3 rounded-md text-sm">Change Password</button>
                        </form>

                        <h2 class="text-center font-semibold text-lg mt-4 mb-2">Work Information</h2>
                        <hr class="my-1 border-white">
                        <form action="{{ route('profile.updateWorkInfo') }}" method="POST">
                            @csrf
                            @method('PATCH')
                            <div class="space-y-3">
                                <div>
                                ...
                                <!-- <div>
                                    ...
                                    <select id="shift_time" name="shift_time" class="mt-1 block w-full bg-gray-200 text-gray-700 rounded-md border-gray-300 focus:ring focus:ring-opacity-50 focus:ring-blue-400 text-sm h-10">
                                        ...
                                        <option value="Early Morning Shift 1 - 02:00AM - 11:00AM" {{ $user->shift_time == 'Early Morning Shift 1 - 02:00AM - 11:00AM' ? 'selected' : '' }}>Early Morning Shift 1 - 02:00AM - 11:00AM</option>
                                        <option value="Early Morning Shift 2 - 03:00AM - 12:00PM" {{ $user->shift_time == 'Early Morning Shift 2 - 03:00AM - 12:00PM' ? 'selected' : '' }}>Early Morning Shift 2 - 03:00AM - 12:00PM</option>
                                        <option value="Early Morning Shift 3 - 05:00AM - 2:00PM" {{ $user->shift_time == 'Early Morning Shift 3 - 05:00AM - 2:00PM' ? 'selected' : '' }}>Early Morning Shift 3 - 05:00AM - 2:00PM</option>
                                        <option value="Morning Shift 1 - 06:00AM - 3:00PM" {{ $user->shift_time == 'Morning Shift 1 - 06:00AM - 3:00PM' ? 'selected' : '' }}>Morning Shift 1 - 06:00AM - 3:00PM</option>
                                        <option value="Morning Shift 2 - 07:00AM - 4:00PM" {{ $user->shift_time == 'Morning Shift 2 - 07:00AM - 4:00PM' ? 'selected' : '' }}>Morning Shift 2 - 07:00AM - 4:00PM</option>
                                        <option value="Regular Shift 1 - 08:00AM - 5:00PM" {{ $user->shift_time == 'Regular Shift 1 - 08:00AM - 5:00PM' ? 'selected' : '' }}>Regular Shift 1 - 08:00AM - 5:00PM</option>
                                        <option value="Regular Shift 2 - 09:00AM - 6:00PM" {{ $user->shift_time == 'Regular Shift 2 - 09:00AM - 6:00PM' ? 'selected' : '' }}>Regular Shift 2 - 09:00AM - 6:00PM</option>
                                        <option value="Mid Shift 1 - 10:00AM - 7:00PM" {{ $user->shift_time == 'Mid Shift 1 - 10:00AM - 7:00PM' ? 'selected' : '' }}>Mid Shift 1 - 10:00AM - 7:00PM</option>
                                        <option value="Mid Shift 2 - 11:00AM - 8:00PM" {{ $user->shift_time == 'Mid Shift 2 - 11:00AM - 8:00PM' ? 'selected' : '' }}>Mid Shift 2 - 11:00AM - 8:00PM</option>
                                        <option value="Store Retail Shift - 12:00PM - 11:00PM" {{ $user->shift_time == 'Store Retail Shift - 12:00PM - 11:00PM' ? 'selected' : '' }}>Store Retail Shift - 12:00PM - 11:00PM</option>
                                        <option value="Noon Shift 1 - 12:00PM - 09:00PM" {{ $user->shift_time == 'Noon Shift 1 - 12:00PM - 09:00PM' ? 'selected' : '' }}>Noon Shift 1 - 12:00PM - 09:00PM</option>
                                        <option value="Noon Shift 2 - 01:00PM - 10:00PM" {{ $user->shift_time == 'Noon Shift 2 - 01:00PM - 10:00PM' ? 'selected' : '' }}>Noon Shift 2 - 01:00PM - 10:00PM</option>
                                        <option value="Noon Shift 3 - 02:00PM - 11:00PM" {{ $user->shift_time == 'Noon Shift 3 - 02:00PM - 11:00PM' ? 'selected' : '' }}>Noon Shift 3 - 02:00PM - 11:00PM</option>
                                        <option value="Night Shift 1 - 09:00PM - 06:00AM" {{ $user->shift_time == 'Night Shift 1 - 09:00PM - 06:00AM' ? 'selected' : '' }}>Night Shift 1 - 09:00PM - 06:00AM</option>
                                        <option value="Night Shift 2 - 10:00PM - 07:00AM" {{ $user->shift_time == 'Night Shift 2 - 10:00PM - 07:00AM' ? 'selected' : '' }}>Night Shift 2 - 10:00PM - 07:00AM</option>
                                        <option value="Night Shift 3 - 11:00PM - 08:00AM" {{ $user->shift_time == 'Night Shift 3 - 11:00PM - 08:00AM' ? 'selected' : '' }}>Night Shift 3 - 11:00PM - 08:00AM</option>
                                    </select>
                                </div> -->
